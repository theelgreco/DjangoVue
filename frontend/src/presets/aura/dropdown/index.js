export default {
  root: ({props, state, parent}) => ({
    class: [
      ...
      {'border-surface-900 dark:border-surface-100': !props.invalid},
      ...
      {'outline-none outline-offset-0 ring-1 ring-primary-500 dark:ring-primary-400 z-10': state.focused && props.variant !== 'filled'},
