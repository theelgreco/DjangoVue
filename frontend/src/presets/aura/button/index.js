export default {
  root: ({props, context, parent}) => ({
    class: [
      ...
      // Link Button
      {'text-primary-400 bg-transparent border-transparent': props.link},
      ...
      {'text-surface-500 border border-grays-light-400 hover:bg-grays-light-100': props.plain && props.outlined},
      ...
      // Primary Button
      {
        'text-white bg-primary border border-primary': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
      },
      // Primary Text Button
      ...
      // Secondary Button
      {
        'text-stone-600 dark:text-white': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
        'bg-grays-light-200 dark:bg-stone-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
        'border border-stone-100 dark:border-stone-700': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
      },
      // Secondary Text Button
      {'text-stone-700 dark:text-stone-300': props.text && props.severity === 'secondary' && !props.plain},
      // Secondary Outlined Button
      {'text-stone-500 dark:text-stone-300 border border-stone-500 hover:bg-stone-300/10': props.outlined && props.severity === 'secondary' && !props.plain},
      ...
      // Primary
      {'hover:bg-primary hover:border-primary-600': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain},
      {'focus:ring-primary': props.severity === null},
      // Text & Outlined Button
      {'hover:bg-primary-300/10': (props.text || props.outlined) && props.severity === null && !props.plain},

      // Secondary
      {'hover:bg-grays-light-300 dark:hover:bg-stone-600 hover:border-stone-200 dark:hover:border-stone-600': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain},
      {'focus:ring-stone-500 dark:focus:ring-stone-400': props.severity === 'secondary'},
      // Text & Outlined Button
      {'hover:bg-stone-100': (props.text || props.outlined) && props.severity === 'secondary' && !props.plain},
