    ...
    incrementbutton: {
        root: ({ parent }) => ({
            class: [
                ...
                { 'rounded-l-none': parent.props.showButtons && parent.props.buttonLayout == 'horizontal' },
                { 'rounded-b-none': parent.props.showButtons && parent.props.buttonLayout == 'vertical' },
    ...
    decrementbutton: {
        root: ({ parent }) => ({
            class: [
                ...
                // Shape
                'rounded-md',
                { 'rounded-t-none rounded-bl-none': parent.props.showButtons && parent.props.buttonLayout == 'stacked' },
                { 'rounded-r-none ': parent.props.showButtons && parent.props.buttonLayout == 'horizontal' },
                { 'rounded-t-none ': parent.props.showButtons && parent.props.buttonLayout == 'vertical' },
