    ...
    button: {
        root: ({parent}) => ({
            class: [
                ...
                // Link Button
                {'text-primary bg-transparent border-transparent': parent.props.link},
                ...
                // Secondary Button
                {
                    'text-stone-600 dark:text-white': parent.props.severity === 'secondary' && !parent.props.text && !parent.props.outlined && !parent.props.plain,
                    'bg-grays-light-200 dark:bg-stone-700': parent.props.severity === 'secondary' && !parent.props.text && !parent.props.outlined && !parent.props.plain,
                    'border border-stone-100 dark:border-stone-700': parent.props.severity === 'secondary' && !parent.props.text && !parent.props.outlined && !parent.props.plain
                },
                // Secondary Text Button
                {'text-stone-700 dark:text-stone-300': parent.props.text && parent.props.severity === 'secondary' && !parent.props.plain},
                // Secondary Outlined Button
                {'text-stone-500 dark:text-stone-300 border border-stone-500 hover:bg-stone-300/10': parent.props.outlined && parent.props.severity === 'secondary' && !parent.props.plain},
                ...
                // Secondary
                {'hover:bg-grays-light-300 dark:hover:bg-stone-600 hover:border-stone-200 dark:hover:border-stone-600': parent.props.severity === 'secondary' && !parent.props.text && !parent.props.outlined && !parent.props.plain},
                {'focus:ring-stone-500 dark:focus:ring-stone-400': parent.props.severity === 'secondary'},
                // Text & Outlined Button
                {'hover:bg-stone-100': (parent.props.text || parent.props.outlined) && parent.props.severity === 'secondary' && !parent.props.plain},
                ...
                // Disabled
                {'opacity-50': parent.props.disabled}
            ]
        }),
        icon: {
            class: [
