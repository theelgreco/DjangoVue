export default {
    ...
    box: ({ props, context }) => ({
        class: [
            ...
            // Colors
            {
                'border-grays-light-400 dark:border-surface-700': !context.checked && !props.invalid,
            ...
            // States
            {
                ...
                'bg-surface-200 dark:bg-surface-700 select-none pointer-events-none cursor-default opacity-40': props.disabled
            },
